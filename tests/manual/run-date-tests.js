...
/**
 * Simple Node.js Test Runner for Date Display Fix
 * Can be run directly: node tests/manual/run-date-tests.js
 */

// Import the test logic from the main test file
const { processExpiryDate } = require('../date-display.test.js');
...
if (require.main === module) {
    ...
    if (args.includes('--help') || args.includes('-h')) {
        console.log('Usage: node run-date-tests.js [options]');
        console.log('');
        console.log('Options:');
